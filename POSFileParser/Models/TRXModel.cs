...
{
    public class TRXModel : ICanParse
    {
        ...
        public List<GiftModel> Gift { get; set; } = new List<GiftModel>();
        /// <summary>
        ...
        /// <summary>
        /// Contains the PAN of the card used to settle the transaction.
        ...
        /// <summary>
        /// Details the pump number per transaction item.
        /// </summary>
        public List<TrxPumpModel> PumpDetail { get; set; }
        /// <summary>
        /// Details the chargepoint number per transaction item.
        /// </summary>
        public TrxChargepointModel ChargepointDetail { get; set; }
        public List<TrxArticleModel> Articles { get; set; }
